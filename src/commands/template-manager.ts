...
import { ProjectTemplate, TemplateConfig } from './types';
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎵 PRP CLI Landing Page loaded');
...
function showDancingMonkeys() {
    ...
    console.log(\`🐵 Spawned \${numberOfMonkeys} dancing monkeys!\`);
}
...
// Console Easter eggs
console.log('%c🎵 PRP CLI Landing Page', 'color: #0ea5e9; font-size: 20px; font-weight: bold;');
console.log('%c🐵 Try adding ?monkeys=true or #monkeys to the URL!', 'color: #f59e0b; font-size: 14px;');
console.log('%cCreated with PRP CLI - Interactive Project Bootstrap', 'color: #64748b; font-size: 12px;');`;
  }
}