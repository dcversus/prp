 ...
 */
import { createNudgeWrapper } from './wrapper';

import type { NudgeWrapper} from './wrapper';
import type {
  AgentNudgeMessage,
  NudgeContext,
...
export class AgentNudgeIntegration {
  private readonly wrapper: NudgeWrapper;
  private readonly templates = new Map<string, NudgeMessageTemplate>();
