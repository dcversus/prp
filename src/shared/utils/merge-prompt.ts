...
export class TOON {
   ...
   */
  static minify(obj: Record<string, any>): string {
   ...
   */
  static parse(toonString: string): Record<string, any> {
...
export class MergePrompt {
  ...
  static async buildOrchestratorPrompt(
    ...
    inspectorPayload?: Record<string, any>,
    prpContext?: string,
