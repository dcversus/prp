...
export class TextProcessor {
  ...
  static async compressText(
    ...
    const targetSize = compression.targetSize;
   ...
   */
  static extractKeyInfo(text: string, preserveStructure?: boolean): {
    headings: string[];
    lists: string[];
    codeBlocks: string[];
    keyPhrases: string[];
   ...
   */
  static mergeChunks(chunks: string[], overlap: number = 50): string {
