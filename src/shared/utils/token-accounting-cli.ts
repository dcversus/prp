...
import { AgentTokenStatus, TokenAlert, TokenDataPoint, TokenUsageEvent } from '../types/token-metrics.js';
...
export class CLITokenAccounting {
  ...
  constructor(tokenStream?: TokenMetricsStream) {
    ...
    this.tokenStream = tokenStream ?? new TokenMetricsStream({
      bufferSize: 100,
   ...
   */
  private displayTokenText(summary: TokenSummary, verbose: boolean = false): void {
